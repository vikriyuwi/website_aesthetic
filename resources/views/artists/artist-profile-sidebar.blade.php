            ...
            <div class="w-1/4 relative">
                <div class="bg-white p-4 rounded-lg shadow-lg relative">
                    ...
                    <div class="text-center">
                        <img src="{{ asset('images/Assets/About me/sam.jpg') }}" alt="Profile picture"
                        ...
                        <button id="followButton" onclick="toggleFollow()"
                            class="bg-green-500 text-white px-4 py-2 rounded-full w-full mt-4 flex items-center justify-center">
                            <i id="followIcon" class="fas fa-user-plus mr-2"></i>
                            <span id="followText">Follow</span>
                        </button>
                        <button onclick="openChatWindow()"
                            class="bg-gray-200 text-gray-700 px-4 py-2 rounded-full w-full mt-1">
                    ...
                    <div class="mt-4 flex justify-center items-center">
                        <button onclick="openHireModal()"
                            class="bg-white border border-indigo-500 rounded-lg p-2 px-4 shadow-md">
