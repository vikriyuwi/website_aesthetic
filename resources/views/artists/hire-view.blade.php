...
<div class="mb-10">
        <label for="comment" class="block text-gray-700 font-medium mb-2">Ask a question or add a comment</label>
        <textarea id="comment" rows="4" placeholder="Write your message..." 
        ...
        <div class="bg-gray-50 p-4 rounded-lg shadow-sm">
            <div class="flex space-x-4 items-start">
                ...
                <div>
                    ...
                    <!-- Reply Button -->
                    <button class="text-indigo-600 mt-2 hover:underline text-sm">Reply</button>
                    ...
                    <div class="mt-4 ml-6 bg-white p-3 border rounded-lg">
                        <div class="flex space-x-4 items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600 mt-1">Yes, I can definitely add a snowy background to match the festive theme!</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-gray-50 p-4 rounded-lg shadow-sm">
            <div class="flex space-x-4 items-start">
                ...
                <div>
                    ...
                    <p class="text-gray-600 mt-2">What file format will you provide for the final illustration?</p>
                    <!-- Reply Button -->
                    <button class="text-indigo-600 mt-2 hover:underline text-sm">Reply</button>
                </div>
            </div>
