            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr class="hover:bg-indigo-50">
                    ...
                    <td class="px-6 py-4 flex items-center">
                        <img
                            src="{{ $buyer->PROFILE_IMAGE_URL != null ? asset($buyer->PROFILE_IMAGE_URL) : "https://placehold.co/100x100"}}" alt="{{ $buyer->FULLNAME }}"
                            alt="Avatar"
                    ...
                    <td class="px-6 py-4 space-x-2">
                        <a href="{{ route('admin.buyer.activate',['id'=>$buyer->BUYER_ID]) }}" class="px-3 py-1 text-white rounded-md
                            @if($buyer->isActive())
                                bg-red-500
                            @else
                                bg-green-500
